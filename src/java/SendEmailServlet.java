...
public class SendEmailServlet extends HttpServlet {
    ...
    private static final String FROM_EMAIL = "vickterpsk@gmail.com";
        ...
        try (PrintWriter out = response.getWriter()) {
            Session session = Session.getInstance(properties, new Authenticator() {
                ...
                protected PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication("vickterpsk@gmail.com", "stsbbgjolxnwvvdm");
                }
            });
            ...
            try {
                ...
                String emailContent = "Name: " + name + "<br/>Contact No: " + contactNo + "<br/>Email: " + email + "<br/>Message: " + messageBody;
